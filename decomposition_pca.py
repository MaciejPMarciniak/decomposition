...
def pca_detailed_atlas_application(path_to_data=os.path.join(str(Path.home()), 'Deformetrica', 'deterministic_atlas_ct',
    ...
    if save_plots:
        ...
        plt.axhline(0.9)
        plt.savefig(os.path.join(str(Path.home()), r'/home/mat/Deformetrica/deterministic_atlas_ct/output_separate_'
                                                   r'tmp{}_def10_prttpe13_corrected/Decomposition'
                                                   r'/Figures/Explained_variance.png'))
        ...
        for i in range(12):
            ...
            plt.savefig(os.path.join(str(Path.home()), r'/home/mat/Deformetrica/deterministic_atlas_ct/output_separate_'
                                                       r'tmp10_def10_prttpe13_corrected/Decomposition'
                                                       r'/Figures/modes_{}_{}.png'.format(i, i + 1)))
            plt.clf()


def pca_get_extremes(path_to_data=os.path.join(str(Path.home()), 'Deformetrica', 'deterministic_atlas_ct',
...
def pca_get_random_combinations(path_to_data=os.path.join(str(Path.home()), 'Deformetrica', 'deterministic_atlas_ct',
                                                          'output_separate_tmp10_def10_prttpe13_corrected',
                                                          'Decomposition'),
                                data_filename='Momenta_Table.csv',
                                output_path=os.path.join(str(Path.home()), 'Deformetrica', 'deterministic_atlas_ct',
                                                          'output_separate_tmp10_def10_prttpe13_corrected',
